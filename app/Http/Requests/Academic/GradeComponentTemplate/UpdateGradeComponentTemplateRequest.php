...
class UpdateGradeComponentTemplateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'evaluation_period_id' => ['sometimes', 'required', 'uuid', 'exists:evaluation_periods,id'],
            ...
            'grading_mode' => ['sometimes', 'required', 'string', 'in:basic_100,mixed_70_30,qualitative'],
