...
class StoreEnrollmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'student.person.first_name' => ['required_without:student.person_id', 'string', 'max:120'],
            'student.person.middle_name' => ['nullable', 'string', 'max:120'],
            'student.person.last_name' => ['required_without:student.person_id', 'string', 'max:120'],
            ...
            'representatives.*.legal_representative.person.first_name' => [
                'required_without:representatives.*.legal_representative.person_id',
                'string',
                'max:120',
            ],
            'representatives.*.legal_representative.person.middle_name' => ['nullable', 'string', 'max:120'],
            'representatives.*.legal_representative.person.last_name' => [
                'required_without:representatives.*.legal_representative.person_id',
                'string',
                'max:120',
            ],
