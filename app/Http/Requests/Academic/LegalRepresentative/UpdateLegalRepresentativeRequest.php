...
namespace App\Http\Requests\Academic\LegalRepresentative;
...
class UpdateLegalRepresentativeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $legalRepresentative = $this->route('legal_representative');
        ...
        return [
            ...
            'students.*.student_id' => ['required_with:students', 'uuid', 'exists:students,id'],
            'students.*.relationship_type' => ['required_with:students', 'string', 'max:80'],
            'students.*.description' => ['nullable', 'string', 'max:5000'],
            'students.*.is_billable' => ['nullable', 'boolean'],
            'students.*.is_emergency_contact' => ['nullable', 'boolean'],
    ...
    {
        $messages = trans('validation/Academic/legal_representative.custom');
    ...
    {
        $attributes = trans('validation/Academic/legal_representative.attributes');
