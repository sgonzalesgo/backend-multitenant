...
//use App\Http\Requests\Administration\Permission\SyncModelPermissionsRequest;
...
//    }
//
//    public function syncModelPermissions(SyncModelPermissionsRequest $req): JsonResponse
//    {
//        $user = $this->repo->syncModelPermissionsByIds(
//            $req->input('user_id'),
...
//            'code'    => 200,
//            'message' => __('messages.models.permissions_synced'),
//            'data'    => $user,
//            'error'   => null,
//        ], Response::HTTP_OK);
//    }
...
class PermissionController extends Controller
{
    ...
    public function index(Request $req): JsonResponse
    {
        ...
        return response()->json([
            'code' => 200,
            'message' => __('messages.permissions.listed'),
            'data' => $data,
            'error' => null,
        ], Response::HTTP_OK);
    }
    ...
    public function show(Permission $permission): JsonResponse
    {
        return response()->json([
            'code' => 200,
            'message' => __('messages.permissions.shown'),
            'data' => $permission,
            'error' => null,
        ], Response::HTTP_OK);
    }
    ...
    public function listRolePermissions(string $role): JsonResponse
    {
        $perms = $this->repo->permissionsForRole($role);

        return response()->json([
            'code' => 200,
            'message' => __('messages.roles.permissions_listed'),
            'data' => $perms,
            'error' => null,
        ], Response::HTTP_OK);
    }

    public function syncRolePermissions(SyncRolePermissionsRequest $req, string $role): JsonResponse
    {
        $role = $this->repo->syncRolePermissionsByIds(
            $role,
            $req->input('permissions', [])
        );
        ...
        return response()->json([
            'code' => 200,
            'message' => __('messages.roles.permissions_synced'),
            'data' => $role,
            'error' => null,
        ], Response::HTTP_OK);
    }
