...
return [
    ...
    'attributes' => [
        ...
        'students.*.is_billable' => 'billable',
        'students.*.is_emergency_contact' => 'emergency contact',
    ...
    'custom' => [
        ...
        // Students
        'students.*.student_id.required_with' => 'The student is required.',
        'students.*.student_id.exists' => 'The selected student is invalid.',
        'students.*.relationship_type.required_with' => 'The relationship type is required.',
