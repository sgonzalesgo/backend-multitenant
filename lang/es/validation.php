...
return [
    ...
    */
    ...
    | atributos utilizando la convención "attribute.rule". Esto permite
    | especificar rápidamente una línea de idioma específica para una regla.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se usan para reemplazar el marcador
