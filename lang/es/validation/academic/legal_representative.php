...
return [
    ...
    'attributes' => [
        ...
        'students.*.student_id' => 'estudiante',
        'students.*.relationship_type' => 'tipo de relación',
        'students.*.description' => 'descripción',
        'students.*.is_billable' => 'facturable',
        'students.*.is_emergency_contact' => 'contacto de emergencia',
    ...
    'custom' => [
        ...
        // Students
        'students.*.student_id.required_with' => 'El estudiante es obligatorio.',
        'students.*.student_id.exists' => 'El estudiante seleccionado no es válido.',
        'students.*.relationship_type.required_with' => 'El tipo de relación es obligatorio.',
