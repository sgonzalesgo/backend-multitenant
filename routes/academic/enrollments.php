...
Route::controller(EnrollmentController::class)->group(function () {
    ...
    Route::post('enrollments/prepare', 'prepare')->middleware('permission:Search enrollments');
    ...
    Route::get('enrollments/{enrollment}', 'show')->middleware('permission:Search enrollments');
